...
export class OPFSCoopSyncVFS extends FacadeVFS {
  ...
  /** @type {Map<string, FileSystemSyncAccessHandle>} */ boundAccessHandles =
    new Map()
  /** @type {Set<FileSystemSyncAccessHandle>} */ unboundAccessHandles =
    new Set()
            ...
            (async () => {
              try {
                ...
                for (const directory of directories) {
                  dirHandle = await dirHandle.getDirectoryHandle(directory, {
                    create,
                  })
                }
