...
declare interface SQLiteVFS {
  ...
  /** @see https://sqlite.org/c3ref/io_methods.html */
  xTruncate(fileId: number, iSizeLo: number, iSizeHi): number

  /** @see https://sqlite.org/c3ref/io_methods.html */
  xSync(fileId: number, flags: number): number

  /** @see https://sqlite.org/c3ref/io_methods.html */
  xFileSize(fileId: number, pSize64: number): number
  ...
  /** @see https://sqlite.org/c3ref/io_methods.html */
  xFileControl(fileId: number, flags: number, pOut: number): number
...
declare interface SQLiteAPI {
   ...
   */
  open_v2(zFilename: string, iFlags?: number, zVfs?: string): number
...
declare module "@effect-x/wa-sqlite/src/examples/tag.js" {
  ...
  export function tag(
    sqlite3: any,
    db: number,
  ): (arg0: TemplateStringsArray, ...args: any[]) => object[]
}
